	...
	profiles: [
		{
			...
			about: {
				text: [
					...
					"Trevor mainly works in JavaScript, namely React.js, but has been known to code in C. You can expect him to easily handle most HTML and CSS tasks. He'd probably use Sass, Redux and Gulp to build a big project, but he's not picky. He's also got a good handle on RESTful API's, and before he devoted his efforts to SPA's he used Bootstrap and jQuery quite a bit. If you're thinking 'would Trevor be good at learning THIS particular tool?' the answer is always Yes."
				]
			},
			projects: [
				{
			...
			contact: [
				{
					...
					link: "mailto:trevor.seibel@gmail.com"
				},
				{
					type: "Github",
					svg:
					...
					link: "https://www.github.com/teebl/"
				},
				{
					type: "LinkedIn",
					svg:
					...
					link: "https://www.linkedin.com/in/trevor-seibel-502218132/"
				},
				{
					type: "Twitter",
					svg:
